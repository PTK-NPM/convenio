"""
Django settings for DoctorNet project.
...
SECRET_KEY = 'django-insecure-hn-_@^zov8b*&j2gcb$&zo=xvyk=wdnaa0!du%qyish==+vt$v'
...
WSGI_APPLICATION = 'DoctorNet.wsgi.application'
